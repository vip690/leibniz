...
//const w='ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖ×ØÙÚÛÜİŞß_';
const w='ABCDEFGHIJKLMNOPQRSTUVWXYZÄÜÖß';
//e='ØÂÌÁÓÆÍß';
//e='ßÁÕÚØŞÌÕ';
...
var i,j,k,g,i2: integer; c: char; s,u: string;
a2:integer;
begin
s:=''; u:='';
i2:=1;
...
memo1.Lines.Add(e);memo1.Lines.Add(s);    memo1.Lines.Add(u);
memo2.Text:=u;
end;
